...
class BasicCancelPage extends StatefulWidget {
  const BasicCancelPage({Key? key}) : super(key: key);

  @override
  State<BasicCancelPage> createState() => _BasicCancelPageState();
}

class _BasicCancelPageState extends State<BasicCancelPage> {
  String? _text;
